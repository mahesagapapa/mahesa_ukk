                              ...
                              <tr>
                                          ...
                                          <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                      <form method="post" action="<?= base_url('Admin/upload_pengaduan/') . $p['id_pengaduan'] ?>">
                                                          <fieldset disabled>
                                                              <div class="row">
                                  ...
                                  <td>
                                      ...
                                      <?php if ($p['status'] == "proses") : ?>
                                          <a type="button" class="btn btn-warning" href="<?=base_url('Admin/statusproses/').$p['id_pengaduan'] ?>">
                                              Proses
                                          </a>
                                      <?php endif ?>
