                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <div class="modal-body">
                                      <form action="<?= base_url('Auth/registrasi_petugas') ?>" method="post">
                              ...
                              <tr>
                                  ...
                                  <td>
                                          ...
                                          <div class="modal fade" id="editpetugas<?= $p['id_petugas'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                              <div class="modal-dialog">
                                                  <form class="modal-content">
                                                      ...
                                                      <div class="modal-body">
                                                          <form method="post" action="<?= base_url('Admin/editpetugas/') . $p['id_petugas'] ?>">
                                                              <div class="form-group">
                                      ...
                                      <?php if ($p['active'] == 'suspend') {?>
                                        <a href="<?= base_url('Admin/unsuspendpetugas/' . $p['id_petugas']) ?>">
                                      ...
                                      <?php } else{ ?>
                                        ...
                                        <a href="<?= base_url('Admin/suspendpetugas/' . $p['id_petugas']) ?>">
