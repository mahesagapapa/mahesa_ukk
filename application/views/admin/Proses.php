                        ...
                        <div class="col-lg mb-4">
                            <div class="card shadow mb-4">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="<?= base_url('Admin/statusproses') . $p['id_pengaduan'] ?>">
                                        <fieldset disabled>
                                            <div class="row">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="d-flex align-text-center">
                                    ...
                                    <a href="<?= base_url('Admin/print_laporan_admin') ?>" type="submit" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
