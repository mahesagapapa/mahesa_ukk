...
<head>
    ...
    <title>SB petugas 2 - Register</title>
    ...
    <link href="<?= base_url('assets/css/sb-petugas-2.min.css') ?>" rel="stylesheet">
...
<body class="bg-gradient-dark">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Setup petugas!</h1>
                            </div>
                            <form class="user" method="post" action="<?= base_url('Auth/setup') ?>">
                                ...
                                <button href="<?= base_url('Auth') ?>" type="submit" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </button>
                                <hr>
                                <div class="text-center">
    ...
    <script src=<?= base_url('assets/js/sb-petugas-2.min.js') ?>></script>
