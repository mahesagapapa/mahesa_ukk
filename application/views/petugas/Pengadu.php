                          ...
                          <?php $no = 1;
                            foreach ($pengaduan as $p) : ?>
                              <tr>
                                  ...
                                  <td>
                                      <!-- detail modal -->
                                      <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#detail<?= $p['id_pengaduan'] ?>">
                                          Detail
                                      </button>
                                          ...
                                          <div class="modal-dialog modal-lg">
                                              <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                      <form method="post" action="<?= base_url('petugas/upload_pengaduan/') . $p['id_pengaduan'] ?>">
                                                          <fieldset disabled>
                                                              <div class="row">
                                  ...
                                  <td>
                                      ...
                                      <?php if ($p['status'] == "proses") : ?>
                                          <a type="button" class="btn btn-warning" href="<?=base_url('petugas/statusproses/').$p['id_pengaduan'] ?>">
                                              Proses
                                          </a>
                                      <?php endif ?>
