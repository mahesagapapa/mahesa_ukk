                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="<?= base_url('petugas/tambah_kategori') ?>">
                                ...
                                <div class="modal fade" id="subkategori" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="modal-body">
                                                    <form action="<?= base_url('petugas/tambah_subkategori') ?>" method="post">
                                                        <div class="form-group">
                                            ...
                                            foreach ($subkategori as $sk) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="editsub<?= $sk['id_subkategori'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" action="<?= base_url('petugas/editsubkategori/' . $sk['id_subkategori']) ?>">
                                                        ...
                                                        <a href="<?= base_url('petugas/deletesubkategori/') . $sk['id_subkategori'] ?>">
